...
export default function Freetrial({ freeTrailData, freeTrailPageSize, freeTrailPage,
    ...
    const dateFormatter = new Intl.DateTimeFormat('en-IN', {
     ...
     console.log(1233)
    console.log('freeTrailData',freeTrailData)
    // console.log("freeTrailPageSize",freeTrailPageSize);
    // console.log('freeTrailPage',freeTrailPage);

    // console.log('setFreeTrailPage',setFreeTrailPage)
    // console.log("freeTrail_PAGE_SIZES",freeTrail_PAGE_SIZES);
    // console.log('setFreeTrailPageSize',setFreeTrailPageSize);
    console.log('freeTrailDate',freeTrailDate);
    // console.log('setFreeTrailDate',setFreeTrailDate);
