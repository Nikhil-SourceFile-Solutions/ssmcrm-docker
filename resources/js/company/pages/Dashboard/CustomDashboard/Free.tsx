...
function Free({ reload, isLoading, setIsLoading }) {
    ...
    const fetchFreeTrials = async () => {
        ...
        try {
            const response = await axios({
                ...
                params: { tab: 'free', dateRange: JSON.stringify(dateRange), filterEmployee: filterEmployee },
                headers: {
    ...
    const columnChart: any = {
        series: [

            {
                ...
                data: freeTrials?.map((call: any) => call.total_calls),
            },
        ],
        options: {
            chart: {
            ...
            xaxis: {
                categories: freeTrials?.map((call: any) => call.first_name),
                axisBorder: {
    ...
    return (
        ...
        <>
            <div className="mb-5 flex items-center justify-between">
                <h5 className="text-lg font-semibold dark:text-white">Free Trials</h5>
