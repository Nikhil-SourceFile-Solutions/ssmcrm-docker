...
function Call({ reload, isLoading, setIsLoading }) {
    ...
    const fetchCalls = async () => {
        ...
        try {
            const response = await axios({
                ...
                params: { tab: 'call', dateRange: JSON.stringify(dateRange), filterEmployee: filterEmployee },
                headers: {
    ...
    const columnChart: any = {
        series: [
            ...
            {
                name: 'Total Calls',
                data: calls?.map((call: any) => call.total_calls),
            },
        ],
        options: {
            chart: {
            ...
            xaxis: {
                categories: calls?.map((call: any) => call.first_name),
                axisBorder: {
