...
export default function Followup({
    ...
    // console.log("followUpPageSize",followUpPageSize);
    // console.log('followUpPage',followUpPage);

    // console.log('setFollowUpPage',setFollowUpPage)
    // console.log("followUp_PAGE_SIZES",followUp_PAGE_SIZES);
    // console.log('followUpReload',followUpReload);
    // console.log('followUpDate',followUpDate);
    // console.log('setFollowUpDate',setFollowUpDate);
