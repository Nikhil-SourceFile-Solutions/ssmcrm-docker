...
export default function Application({ leads, drawer, setDrawer, selectedRecords }) {
    ...
    const validate = () => {
        ...
        if (!params.script_name) {
            errors = { ...errors, script_name: "Instrument Name required" };
        }
        console.log(errors);
        setErros(errors);
    ...
    const AppApplicationNotification = async (data: any) => {
        setBtnLoading(true)
        try {
    ...
    const formSubmit = () => {
        ...
        AppApplicationNotification(data);
    };
    ...
    return (
        <div className=" pt-5">
            <div className=' grid grid-cols-1 md:grid-cols-2 gap-2' >
                ...
                <div className='mb-4'>
                    <select onChange={(e) => changeValue(e)} name="action" value={params.action} className="form-select text-white-dark  py-2 text-sm ">
                ...
                <div className='mb-4'>
                    <input type="text" placeholder="Enter Entry Price " className="form-input"
                ...
                <div className='mb-4'>
                    <input type="text" placeholder="Enter Stoloss" className="form-input"
            ...
            <footer className="w-full text-center border-t border-grey p-4">
                <div className='flex justify-end gap-5 py-2'>
                    ...
                    <button onClick={() => { formSubmit() }} type='button' disabled={btnLoading} className='btn btn-dark'> {btnLoading ? 'Please Wait' : 'Send Advice'} </button>
                </div>
            </footer>
        </div>
    )
