...
export default function SmsUpdatedCampaign({ showSmsUpdatedData, setShowSmsUpdatedData, reportData, fetchData1 }: any) {
    ...
    return (
        <div>
            <div className={`${(showSmsUpdatedData && '!block') || ''} fixed inset-0 bg-[black]/60 z-[51] px-4 hidden transition-[display]`} onClick={() => setShowSmsUpdatedData(!showSmsUpdatedData)}>
            </div>
            <nav className={`${(showSmsUpdatedData && 'ltr:!right-0 rtl:!left-0') || ''} bg-white fixed ltr:-right-[800px] rtl:-left-[800px] top-0 bottom-0 w-full max-w-[600px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-[right] duration-1000 z-[51] dark:bg-black p-4 pt-0`}>
