                ...
                <div className="bg-white dark:bg-black h-full">
                    <div className="flex justify-between items-center px-4 py-3">
                        <NavLink to="/" className="main-logo flex items-center shrink-0">
                            ...
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5 font-semibold align-middle lg:inline dark:text-white-light">{t('Sourcefile CRM')}</span>
                        </NavLink>
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'dashboard' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/">{t('Leads Dashboard')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/">{t('Sales Dashboard')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/">{t('finance')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/">{t('crypto')}</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
