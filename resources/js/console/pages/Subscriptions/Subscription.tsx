...
export default function Subscription({ showSubscriptionsViewDrawer, setSubscriptionsViewShowDrawer }: any) {
    ...
    return (
        <div>
            <div className={`${(showSubscriptionsViewDrawer && '!block') || ''} fixed inset-0 bg-[black]/60 z-[51] px-4 hidden transition-[display]`} onClick={() => setSubscriptionsViewShowDrawer(false)}></div>
            <nav className={`${(showSubscriptionsViewDrawer && 'ltr:!right-0 rtl:!left-0') || ''
