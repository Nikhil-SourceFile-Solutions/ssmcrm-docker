                ...
                <div className="bg-white dark:bg-black h-full">
                    <div className="flex justify-between items-center px-4 py-3">
                        <NavLink to="/" className="main-logo flex items-center shrink-0">
                            <img className="w-[160px] ltr:-ml-1 rtl:-mr-1 inline" src="/assets/images/logo.png" alt="logo" />
                        </NavLink>
                        <button
                            type="button"
                        ...
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                            ...
                            <li className="nav-item">
                                <ul>
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/listplans" className="group">
                                            <div className="flex items-center">
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/listsubscriptions" className="group">
                                            <div className="flex items-center">
                            ...
                            <li className="menu nav-item">
                                <NavLink to="/contact" className="nav-link group">
                                    <div className="flex items-center">
                            ...
                            <li className="menu nav-item">
                                <NavLink to="/scripts" className="nav-link group">
                                    <div className="flex items-center">
                                        <IconMenuDocumentation className="group-hover:!text-primary shrink-0" />
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Scripts')}</span>
                                    </div>
                                </NavLink>
                            </li>
