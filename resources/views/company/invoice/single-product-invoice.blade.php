...
<body>
    <div class="invoice-container">
        ...
        <div class="content">
                ...
                <tr>
                        ...
                        <div class="to-section">
                         ...
                         <p style="margin: 0;margin-bottom:5px">Phone: +91 {{ $userData['phone'] }}</p>
                           @endif
                             ...
                             @if($userData['email']) 
                          <p style="margin: 0;margin-bottom:8px">Email: {{ $userData['email'] }}</p>
                           @endif
                           
                          @if($userData['gst_no']) 
                          <p style="margin: 0;margin-bottom:5px">GST: {{ $userData['gst_no'] }}</p>
                           @endif
                        </div>
                    </td>
                    <td class="right-section">
                        ...
                        @if ($invoiceData['gst_no'])
                            <P style="margin: 0;margin-bottom:5px">{{ $invoiceData['gst_no'] }}</P>
                        @endif
                    </td>
                </tr>
            </table>
            ...
            border-color: #b8b6b6;  border-left: none;
            border-right: none;
            border-bottom: none;">
                            ...
                            <p style="margin: 0 0 10px 0">
                                ...
                                @if ($saleService)
                                    ...
                                    @foreach ($saleService as $service)
                                        <span
                                            style="background: #f0f1f0;padding: 2px;margin-right: 4px;border-radius: 3px;">
